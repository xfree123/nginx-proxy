#!/bin/bash
# Script by Xfree
# Script Date: Tue Dec 17 03:47:00 PM +07 2024
# Apply For: Centos 9/Rocky9 RHEL 9
...
unzip -o echo-nginx-module.zip
unzip -o ngx_cache_purge.zip
unzip -o set-misc-nginx-module.zip
unzip -o headers-more-nginx-module.zip
unzip -o ngx_devel_kit.zip
unzip -o nginx-module-vts.zip
unzip -o ngx_log_if.zip
...
make install
t=$SECONDS
printf 'Time taken on build: %d days, %d minutes\n' "$(( t/86400 ))" "$(( t/60 - 1440*(t/86400) ))"
